...
class EqualAreaDodecahedron {
public:
	EqualAreaDodecahedron(Renderable & r, cgiDouble128NS::double128 numFaces);
	~EqualAreaDodecahedron();
	...
	//Pentagon Slerp
	cgiDouble128NS::double128 slerpBinarySearch(d128Vec3 source, d128Vec3 dest, d128Vec3 dest2, cgiDouble128NS::double128 targetArea);
